...
public class Transaction {
    Transaction(String ID, String name, String category, String quantity, String price, String total, String profit) throws IOException {
        String pathDB = System.getProperty("user.dir") + "\\src\\Database\\StockOut.txt";
